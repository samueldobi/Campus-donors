...
<section class="why-donate mt-5 mb-5">
        ...
        <div class="d-md-flex justify-content-evenly mt-5 mb-5">
            ...
            <div class="col-10 col-md-3 rounded border m-2 p-3 why-box">
                ...
                <p class="m-1 p-2">
                The University of Benin’s blood donation programs also serve as educational platforms, raising awareness about the importance of regular donations and the science behind blood banking. 
                </p>
            </div>
        </div>

        <div class=" button-links p-2  text-center">
            <a href="donate.php">
